...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{images/feedback_diagrams/chapter3/mlp/mlp.drawio.pdf}
    \caption{多层感知机中固定长度声学特征向量、全连接层、偏置项和激活函数的基本关系}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{images/feedback_diagrams/chapter3/cnn/cnn.drawio.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{images/feedback_diagrams/chapter3/rnn/rnn.drawio.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{images/feedback_diagrams/chapter3/attention/self_attention.drawio.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.82\textwidth]{images/chapter3/chapter3_attention_qkv.drawio.pdf}
    \caption{缩放点积注意力中的查询、键、值计算流程}
    \label{fig:chapter3_attention_qkv}
\end{figure}

缩放点积注意力的特点在于分数计算基于矩阵乘法。这种计算方式相对有利于并行计算，在实际实现中可能在计算效率和内存使用方面具有一定优势\cite{vaswani2017attention,chen2023dwformer,wang2024swin}。在语音情绪识别中，缩放点积注意力可用于反映特定时间帧或局部区域与其他位置之间的情绪相关性，从而相对突出地强调发话中的关键区间\cite{he2023multiple}。
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.82\textwidth]{images/chapter3/chapter3_transformer_encoder.drawio.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{images/chapter3/chapter3_transformer_ser_boundary.drawio.pdf}
